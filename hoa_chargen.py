...
__app__ = 'HOA CharGen 0.1.0 (Beta)'
...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.flag_choice = ['Choose', 'Aegypt', 'Nubia', 'Babylon', 'Troy', 'Greece', 'Atlantis']
        self.flag_language = ['', 'Egyptian', 'Egyptian', 'Babylonian', 'Greek', 'Greek', 'Minoan']
    ...
    def printButton_clicked(self):
        ...
        pdf.ln()
        pdf.cell(txt='Ancient Flag: ' + self.flag_chosen + '        Language: ' + self.languageDisplay.text())
        pdf.ln()
        pdf.cell(txt='Class: ' + self.dept_chosen)
        pdf.ln()
...
if __name__ == '__main__':
    ...
    log = logging.getLogger('HOA_Chargen')
